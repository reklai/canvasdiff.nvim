...
--- happens to use. `vim.keycode` expands `<Leader>`/`<leader>` using
--- `g:mapleader` (defaulting to backslash), so `<leader>`-style lhs
--- normalize correctly through it too. Put BOTH sides through this.
